...
_junk = r"[^א-ת"+_NIKUD+"a-zA-Z0-9!?.,:;\-()\[\]{}]+" #%%&!?.,;:\-()\[\]{}\"'\/\\+]+" #% _NIKUD

is_all_heb = re.compile(rf"^{_heb_letter}+$",re.UNICODE).match
is_a_number = re.compile(rf"^{_numeric}$" ,re.UNICODE).match
